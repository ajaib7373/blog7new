...
<section class="container">
    ...
    font-size: 1.5rem;" > Showing posts with the category "{{$category->name}}"  </a>
                </div>
            @foreach($posts as $post) 
                    <div class="post-content" data-aos="zoom-in" data-aos-delay="200">
                        ...
                        <div class="post-title">
                         ...
                         <a href="/posts/{{$post->slug}}"><button class="btn post-btn">Read More &nbsp; <i class="fas fa-arrow-right"></i></button>
                        </div></a>   
