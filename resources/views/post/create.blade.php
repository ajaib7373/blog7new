...
@endif
  ...
  @csrf
    ...
    <input type="text" id="fname" name="intro" placeholder="the intro here.." value="{{ old('intro')}}">
    <p style="color: red; font-size:20px ;">@error('intro') {{$message}} @enderror</p>

    <label for="Body">Body 1</label>
    <textarea id="subject" name="body1" placeholder="body1.." style="height:200px" >{{ old('body1')}}</textarea>
    <p style="color: red; font-size:20px ;">@error('body1') {{$message}} @enderror</p>

    <label for="image">Image 1</label>
    <input type="file" id="lname" name="image1"> 
    ...
    <textarea id="subject" name="body3" placeholder="body3.." style="height:200px">{{ old('body3')}}</textarea>
    ...
    <textarea id="subject" name="body4" placeholder="body4.." style="height:200px">{{ old('body4')}}</textarea>
    ...
    <textarea id="subject" name="body5" placeholder="body5.." style="height:200px">{{ old('body5')}}</textarea>
